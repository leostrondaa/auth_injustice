...
class _PasswordAnalyzer {
  static Map<String, dynamic> check(String password) {
    ...
    final analysis = password_validator.PasswordValidator.analyze(password);

    return {
      'strength': PasswordStrength.fromProgress(analysis.progress),
      'requirements': [
        PasswordIndicatorRequirement(
          type: PasswordRequirementType.minLength,
          isMet: analysis.hasMinLength,
        ),
        PasswordIndicatorRequirement(
          type: PasswordRequirementType.lowercaseAndUppercase,
          isMet: analysis.hasLowercase && analysis.hasUppercase,
        ),
        PasswordIndicatorRequirement(
          type: PasswordRequirementType.number,
          isMet: analysis.hasNumber,
        ),
        PasswordIndicatorRequirement(
          type: PasswordRequirementType.symbol,
          isMet: analysis.hasSymbol,
        ),
      ],
    };
  }
